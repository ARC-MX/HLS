...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module top_pe_index_table_rom (
...
initial begin
    $readmemh("./top_pe_index_table_rom.dat", ram0);
    $readmemh("./top_pe_index_table_rom.dat", ram1);
    $readmemh("./top_pe_index_table_rom.dat", ram2);
    $readmemh("./top_pe_index_table_rom.dat", ram3);
    $readmemh("./top_pe_index_table_rom.dat", ram4);
end
...
top_pe_index_table_rom top_pe_index_table_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
