...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("input_buffers_Addr_A", 32, hls_out, 0, "bram", "MemPortADDR2", 1),
	Port_Property("input_buffers_EN_A", 1, hls_out, 0, "bram", "MemPortCE2", 1),
	Port_Property("input_buffers_WEN_A", 1, hls_out, 0, "bram", "MemPortWE2", 1),
	Port_Property("input_buffers_Din_A", 8, hls_out, 0, "bram", "MemPortDIN2", 1),
	Port_Property("input_buffers_Dout_A", 8, hls_in, 0, "bram", "MemPortDOUT2", 1),
	Port_Property("input_buffers_Clk_A", 1, hls_out, 0, "bram", "mem_clk", 1),
	Port_Property("input_buffers_Rst_A", 1, hls_out, 0, "bram", "mem_rst", 1),
	Port_Property("input_buffers_Addr_B", 32, hls_out, 0, "bram", "MemPortADDR2", 1),
	Port_Property("input_buffers_EN_B", 1, hls_out, 0, "bram", "MemPortCE2", 1),
	Port_Property("input_buffers_WEN_B", 1, hls_out, 0, "bram", "MemPortWE2", 1),
	Port_Property("input_buffers_Din_B", 8, hls_out, 0, "bram", "MemPortDIN2", 1),
	Port_Property("input_buffers_Dout_B", 8, hls_in, 0, "bram", "MemPortDOUT2", 1),
	Port_Property("input_buffers_Clk_B", 1, hls_out, 0, "bram", "mem_clk", 1),
	Port_Property("input_buffers_Rst_B", 1, hls_out, 0, "bram", "mem_rst", 1),
	...
	Port_Property("pe_input_stream_V_0_din", 8, hls_out, 2, "ap_fifo", "fifo_data", 60),
	Port_Property("pe_input_stream_V_0_full_n", 1, hls_in, 2, "ap_fifo", "fifo_status", 60),
	Port_Property("pe_input_stream_V_0_write", 1, hls_out, 2, "ap_fifo", "fifo_update", 60),
	...
	Port_Property("pe_input_stream_V_6_din", 8, hls_out, 8, "ap_fifo", "fifo_data", 60),
	Port_Property("pe_input_stream_V_6_full_n", 1, hls_in, 8, "ap_fifo", "fifo_status", 60),
	Port_Property("pe_input_stream_V_6_write", 1, hls_out, 8, "ap_fifo", "fifo_update", 60),
