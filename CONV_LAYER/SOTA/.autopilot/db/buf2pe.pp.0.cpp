...
# 11 "CONV_LAYER/buf2pe.cpp"

#pragma HLS ARRAY_PARTITION variable=pe_input_stream complete dim=1
# 11 "CONV_LAYER/buf2pe.cpp"

#pragma HLS INTERFACE bram storage_type=ram_t2p port=input_buffers
# 11 "CONV_LAYER/buf2pe.cpp"
...
#pragma HLS ARRAY_PARTITION variable=input_registers complete dim=1
# 13 "CONV_LAYER/buf2pe.cpp"

#pragma HLS ARRAY_PARTITION variable=input_registers complete dim=2
# 13 "CONV_LAYER/buf2pe.cpp"
...
#pragma HLS ARRAY_PARTITION variable=inner_fifos complete dim=1
# 18 "CONV_LAYER/buf2pe.cpp"
...
# 33 "CONV_LAYER/buf2pe.cpp"
                ...
                VITIS_LOOP_34_3: for (int kernel_x = 0; kernel_x < Nkx; kernel_x++)
                {
