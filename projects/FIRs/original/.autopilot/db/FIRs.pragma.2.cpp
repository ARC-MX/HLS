...
constexpr int NUM_TAP = 11;
typedef ap_uint<16> input_t;
typedef ap_uint<16> coef_t;
typedef ap_uint<16 + 16 + 4> output_t;

__attribute__((sdx_kernel("standard", 0))) void standard(hls::stream<input_t> &src, hls::stream<output_t> &dst);
# 3 "../srcs/FIRs.cpp" 2
...
__attribute__((sdx_kernel("top", 0))) void top(hls::stream<input_t> &src, hls::stream<output_t> &dst)
{
